...
async function fetchFlowerCount() {
  ...
  try {
    const response = await fetch('https://flowers-world-two.vercel.app/orders/');
    if (!response.ok) {
      throw new Error(`HTTP error! Status: ${response.status}`);
    }
...
async function fetchBuyerCount() {
    try {
      // Fetch the data from the server
      const response = await fetch('https://flowers-world-two.vercel.app/buyers/list/');
      if (!response.ok) {
        throw new Error(`HTTP error! Status: ${response.status}`);
      }
  ...
  async function fetchUserCount() {
    try {
      // Fetch the data from the server
      const response = await fetch('https://flowers-world-two.vercel.app/users/');
      if (!response.ok) {
        throw new Error(`HTTP error! Status: ${response.status}`);
      }
  ...
  async function fetchCounts() {
    try {
      // Fetch category data
      const categoryResponse = await fetch('https://flowers-world-two.vercel.app/categories/');
      ...
      // Fetch color data
      const colorResponse = await fetch('https://flowers-world-two.vercel.app/colors/');
      if (!colorResponse.ok) {
      ...
      // Fetch review data
      const reviewResponse = await fetch('https://flowers-world-two.vercel.app/flowers/reviews/');
  ...
  async function fetchServiceAndContactCounts() {
    try {
      // Fetch service data
      const serviceResponse = await fetch('https://flowers-world-two.vercel.app/services/');
      ...
      const contactResponse = await fetch('https://flowers-world-two.vercel.app/contact_us/');
